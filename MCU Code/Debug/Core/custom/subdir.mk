...
C_SRCS += \
../Core/custom/custom.c 

OBJS += \
./Core/custom/custom.o 

C_DEPS += \
./Core/custom/custom.d 


# Each subdirectory must supply rules for building sources it contributes
Core/custom/%.o Core/custom/%.su Core/custom/%.cyclo: ../Core/custom/%.c Core/custom/subdir.mk
...
clean-Core-2f-custom:
	-$(RM) ./Core/custom/custom.cyclo ./Core/custom/custom.d ./Core/custom/custom.o ./Core/custom/custom.su
