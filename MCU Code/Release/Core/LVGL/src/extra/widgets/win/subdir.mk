...
C_DEPS += \
./Core/LVGL/src/extra/widgets/win/lv_win.d 


# Each subdirectory must supply rules for building sources it contributes
Core/LVGL/src/extra/widgets/win/%.o Core/LVGL/src/extra/widgets/win/%.su Core/LVGL/src/extra/widgets/win/%.cyclo: ../Core/LVGL/src/extra/widgets/win/%.c Core/LVGL/src/extra/widgets/win/subdir.mk
...
clean: clean-Core-2f-LVGL-2f-src-2f-extra-2f-widgets-2f-win

clean-Core-2f-LVGL-2f-src-2f-extra-2f-widgets-2f-win:
	-$(RM) ./Core/LVGL/src/extra/widgets/win/lv_win.cyclo ./Core/LVGL/src/extra/widgets/win/lv_win.d ./Core/LVGL/src/extra/widgets/win/lv_win.o ./Core/LVGL/src/extra/widgets/win/lv_win.su

.PHONY: clean-Core-2f-LVGL-2f-src-2f-extra-2f-widgets-2f-win
