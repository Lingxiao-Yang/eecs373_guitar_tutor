...
C_DEPS += \
./Core/LVGL/src/extra/libs/rlottie/lv_rlottie.d 


# Each subdirectory must supply rules for building sources it contributes
Core/LVGL/src/extra/libs/rlottie/%.o Core/LVGL/src/extra/libs/rlottie/%.su Core/LVGL/src/extra/libs/rlottie/%.cyclo: ../Core/LVGL/src/extra/libs/rlottie/%.c Core/LVGL/src/extra/libs/rlottie/subdir.mk
...
clean: clean-Core-2f-LVGL-2f-src-2f-extra-2f-libs-2f-rlottie

clean-Core-2f-LVGL-2f-src-2f-extra-2f-libs-2f-rlottie:
	-$(RM) ./Core/LVGL/src/extra/libs/rlottie/lv_rlottie.cyclo ./Core/LVGL/src/extra/libs/rlottie/lv_rlottie.d ./Core/LVGL/src/extra/libs/rlottie/lv_rlottie.o ./Core/LVGL/src/extra/libs/rlottie/lv_rlottie.su

.PHONY: clean-Core-2f-LVGL-2f-src-2f-extra-2f-libs-2f-rlottie
